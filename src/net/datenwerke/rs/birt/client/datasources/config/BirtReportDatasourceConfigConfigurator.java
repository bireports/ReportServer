...
public class BirtReportDatasourceConfigConfigurator implements DatasourceDefinitionConfigConfigurator {
	...
	@Override
	public Iterable<Widget> getFormfields(DatasourceDefinitionConfigDto config, DatasourceDefinitionDto datasourceDefinitionDto, final DatasourceSelectionField datasourceSelectionField) {
