...
public interface ConditionRpcService extends RemoteService{
	...
	List<ConditionDto> getConditions() throws ServerCallFailedException, ExpectedException;
	
	List<String> getReplacementsFor(ConditionDto condition) throws ServerCallFailedException, ExpectedException;
