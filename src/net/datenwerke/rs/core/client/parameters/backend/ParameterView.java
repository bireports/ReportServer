...
public class ParameterView extends MainPanelView{
	...
	public Component getViewComponent() {
		...
		panel.setHeadingText(ParametersMessages.INSTANCE.mainPanelView_headline());
		panel.add(container);
	...
	protected void displayEditParameter(final ParameterDefinitionDto definition) {
		WestPropertiesDialog editParameterWindow = new WestPropertiesDialog();
		editParameterWindow.setOnEsc(false);
		
		editParameterWindow.setHeadingText(ParametersMessages.INSTANCE.editParameter() + (definition.getKey() == null ? "key" : definition.getKey())); //$NON-NLS-1$
	...
	protected Widget createParameterMainOptionsPanel(final ParameterDefinitionDto definition) {
		...
		DwContentPanel panel = new DwContentPanel();
		panel.setLightHeader();
		panel.setHeadingText(ParametersMessages.INSTANCE.parameterProperties() + " (" + ParametersMessages.INSTANCE.generalPoperties() + ")");
	...
	protected Widget createParameterSpecialOptionsPanel(ParameterDefinitionDto definition) {
		...
		wrapper.setHeadingText(ParametersMessages.INSTANCE.parameterProperties() + " (" + ParametersMessages.INSTANCE.specialProperties() + ")");
