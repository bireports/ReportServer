...
public class ReportViewExportButtonHooker implements ReportExecutorViewToolbarHook {
	...
	@Override
	public boolean reportPreviewViewToolbarHook_addLeft(ToolBar toolbar, final ReportDto report, final ReportExecutorInformation info, ReportExecutorMainPanel mainPanel) {
		...
		while(exporterIt.hasNext()){
			...
			initButton(item, exporter, report, info);
			exportMenu.add(item);
		}
	...
	private void initButton(DwTextButton btn, final ReportExporter exporter, final ReportDto report, final ReportExecutorInformation info ) {
	...
	private void initButton(MenuItem btn, final ReportExporter exporter, final ReportDto report, final ReportExecutorInformation info ) {
