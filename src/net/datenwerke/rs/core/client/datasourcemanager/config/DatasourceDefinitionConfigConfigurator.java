...
public interface DatasourceDefinitionConfigConfigurator {
	...
	public Iterable<Widget> getFormfields(DatasourceDefinitionConfigDto config, DatasourceDefinitionDto datasourceDefinitionDto, DatasourceSelectionField datasourceSelectionField);
