...
public class DashboardMainComponent extends DwContentPanel implements DashboardContainer{
	...
	protected void initToolbar() {
		...
		editDashboardItem.addSelectionHandler(new SelectionHandler<Item>() {
			@Override
		...
		editOrderDashboardItem.addSelectionHandler(new SelectionHandler<Item>() {
			@Override
			public void onSelection(SelectionEvent<Item> event) {
				editDashboardOrder();
			}
		...
		addDashboardItem.addSelectionHandler(new SelectionHandler<Item>() {
		...
		addReferencedDashboardItem.addSelectionHandler(new SelectionHandler<Item>() {
		...
		resetReferencedDashboardItem.addSelectionHandler(new SelectionHandler<Item>() {

			@Override
			public void onSelection(SelectionEvent<Item> event) {
				resetReferenceDashboard();
			}
		});
		...
		removeDashboardItem.addSelectionHandler(new SelectionHandler<Item>() {
			@Override
			public void onSelection(SelectionEvent<Item> event) {
				ConfirmMessageBox cmb = new DwConfirmMessageBox(DashboardMessages.INSTANCE.removeDashboardConfirmTitle(), DashboardMessages.INSTANCE.removeDashboardConfirmMsg());
	...
	protected void editDashboardOrder() {
		...
		window.setHeadingText(DashboardMessages.INSTANCE.editDashboardOrder());
	...
	protected void createReferenceDashboard() {
		TreeSelectionPopup popup = new TreeSelectionPopup(dashboardTree, DashboardNodeDto.class){
			@Override
	...
	protected void editDashboard() {
		final DwWindow window = new DwWindow();
		window.setHeadingText(DashboardMessages.INSTANCE.editDashboard());
		window.setWidth(450);
