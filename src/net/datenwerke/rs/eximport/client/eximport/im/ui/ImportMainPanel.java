...
public class ImportMainPanel extends DwContentPanel {
	...
	private void initializeUI() {
		...
		/* init us */
		setHeadingText(ExImportMessages.INSTANCE.importPanelHeader());
	...
	protected void displayMainOptions() {
		...
		dialog.setHeadingText(ExImportMessages.INSTANCE.mainOptionsButtonLabel());
	...
	protected void displayBeginImport() {
		...
		window.setHeadingText(ExImportMessages.INSTANCE.beginImportButtonLabel());
