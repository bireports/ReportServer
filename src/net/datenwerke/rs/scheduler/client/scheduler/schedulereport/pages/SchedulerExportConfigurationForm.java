...
public class SchedulerExportConfigurationForm extends DwContentPanel implements Validatable, WizardAware {
	...
	protected void initForm(ReportDto report, Collection<ReportViewConfiguration> configs, ArrayList<SendToClientConfig> sendToConfigs, ReportScheduleDefinition definition) {
		...
		wrapper.setHeadingText(SchedulerMessages.INSTANCE.exportConfigHeadline());
