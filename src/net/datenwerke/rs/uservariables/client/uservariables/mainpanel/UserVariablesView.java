...
public class UserVariablesView extends MainPanelView {
	...
	public Component getViewComponent() {
		...
		herePanel.setHeadingText(UserVariablesMessages.INSTANCE.mainPanelView_description());
		herePanel.add(hereGridComponent);
		
		/* add inherited grid */
		DwContentPanel inheritedPanel = new DwContentPanel();
		inheritedPanel.setLightHeader();
		inheritedPanel.setHeadingText(UserVariablesMessages.INSTANCE.mainPanelView_inheritedDescription());
	...
	protected void displayEditVariable(final UserVariableInstanceDto instance) {
		...
		window.setHeadingText(UserVariablesMessages.INSTANCE.editVariable() + (instance.getDefinition().getName() == null ? BaseMessages.INSTANCE.unknown() : instance.getDefinition().getName())); 
