...
public class UserVariablesDefinitionPanel extends MainPanelView {
	...
	public Widget getViewComponent() {
		...
		/* headline */
		view.setHeadingText(UserVariablesMessages.INSTANCE.viewHeadline());
	...
	protected void displayEditVariable(final UserVariableDefinitionDto definition) {
		...
		window.setHeadingText(UserVariablesMessages.INSTANCE.editVariable() + (definition.getName() == null ? BaseMessages.INSTANCE.unnamed() : definition.getName())); 
