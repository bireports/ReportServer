...
public class ColumnFormatWindow extends DwWindow {
	...
	private void initUi() {
		...
		setHeadingText(FilterMessages.INSTANCE.formatDialogHeading(column.getName(), null != column.getType() ? SqlTypes.getName(column.getType()) : ""));
		setOnEsc(false);
		setClosable(false);
		...
		wrapper.setHeadingText(FilterMessages.INSTANCE.formatTitle());
		wrapper.add(form);
