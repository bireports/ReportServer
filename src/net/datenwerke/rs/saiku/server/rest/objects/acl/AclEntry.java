...
package net.datenwerke.rs.saiku.server.rest.objects.acl;

import java.util.List;
import java.util.Map;

import net.datenwerke.rs.saiku.server.rest.objects.acl.enumeration.AclMethod;
import net.datenwerke.rs.saiku.server.rest.objects.acl.enumeration.AclType;
