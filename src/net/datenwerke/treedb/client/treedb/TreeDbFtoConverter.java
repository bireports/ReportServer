...
public class TreeDbFtoConverter {
	...
	public AbstractNodeDtoDec convert(String[] fto){
		...
		for(PropertyAccessor pa : dto.getPropertyAccessors()){
			String val = fto[cnt++];
			if(val.startsWith("_fto_ignore_this:") || val.startsWith("_fto_dto_type:") || val.startsWith("_fto_dto_id:"))
				continue;
	...
	private Object valueOf(String str, Class<?> type){
		...
		throw new RuntimeException("Don't know how to convert from String to " + type.getName());
	}
