...
public class SchedulerTask implements Callable<SchedulerTaskResult> {
	...
	public SchedulerTaskResult safeCall() throws Exception {
		...
		try{
			...
			try{
				...
				if(null != veto){
					/* notify hookers aboutJobExecution */
					notifyHookersAboutVetor(executionHookers, veto, hookerErrorBuilder);
				} else {
					/* execute job */
					executeJob(executionHookers, hookerErrorBuilder);
					
					/* execute actions */
					executeActions(executionHookers, hookerErrorBuilder);
	...
	private void notifyHookersAboutVetor(
	...
	private void executeActions(List<SchedulerExecutionHook> executionHookers, StringBuilder hookerErrorBuilder) throws Exception {
