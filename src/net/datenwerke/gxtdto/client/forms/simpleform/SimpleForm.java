...
public class SimpleForm extends DwContentPanel {
	...
	protected Container fieldWrapper = new VerticalLayoutContainer();
	...
	public void setFieldWrapper(Container wrapper) {
		mainForm.remove(fieldWrapper);

		this.fieldWrapper = wrapper;
		mainForm.setWidget(fieldWrapper);
	}
