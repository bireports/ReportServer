...
public class DtoServiceImpl implements DtoMainService, DtoService {
	...
	public DtoServiceImpl(
		...
		dtoGeneratorByPosoLookup.put(net.datenwerke.rs.condition.service.condition.entity.Condition.class, injector.getInstance(net.datenwerke.rs.condition.service.condition.entity.dtogen.Condition2DtoGenerator.class));
		...
		dto2PosoGeneratorLookup.put(net.datenwerke.rs.condition.client.condition.dto.ConditionDto.class, injector.getInstance(net.datenwerke.rs.condition.service.condition.entity.dtogen.Dto2ConditionGenerator.class));
		...
		dtoClassLookup.add(net.datenwerke.rs.condition.client.condition.dto.ConditionDto.class);
		...
		posoClassLookup.add(net.datenwerke.rs.condition.service.condition.entity.Condition.class);
