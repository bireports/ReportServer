...
# use reportserver; 
    ...
    alter table RS_SCHED_EXECUTE_REPORT_JOB 
        add index FK_9r2tihgonmk0lnoi3904ssop2 (user_id), 
    ...
    alter table RS_SCHED_EXECUTE_SCRIPT_JOB 
        add index FK_jnch30f1onk69k047p7kwmnlj (user_id), 
    ...
    alter table RS_TEAMSPACE_2_MEMBER 
        add index FK_j6p1u1dx4vo2m8nv0jssdukul (members_id), 
        add constraint FK_j6p1u1dx4vo2m8nv0jssdukul 
        foreign key (members_id) 
        references RS_TEAMSPACE_MEMBER (ENTITY_ID);

    alter table RS_TEAMSPACE_2_MEMBER 
        add index FK_fiyxn4jmrjyqyt21ykqymwbh5 (teamspace_id), 
        add constraint FK_fiyxn4jmrjyqyt21ykqymwbh5 
        foreign key (teamspace_id) 
        references RS_TEAMSPACE (ENTITY_ID);

    alter table RS_TEAMSPACE_2_MEMBER_A 
        add index FK_ng4n8pkvlfmsdvijid7lbjeme (REV), 
    ...
    alter table RS_TEAMSPACE_MEMBER 
        add index FK_10q292y1oxchluq48pe24h3mt (user_id), 
    ...
    insert into RS_SCHEMAINFO(KEY_FIELD, value) VALUES('version', 'RS3.0.3-6003');
    insert into RS_SCHEMAINFO(KEY_FIELD, value) VALUES('schemaversion', 'RS3.0-9');
